...
class _ModelManagementScreenState extends State<ModelManagementScreen> {
  ...
  final List<Map<String, dynamic>> availableModels = [
    ...
    {'name': 'tiny.en-q5_1', 'size': '31 MB', 'description': '最小・最速 (英語専用, Q5_1)'},
    {'name': 'tiny.en-q8_0', 'size': '42 MB', 'description': '最小・最速 (英語専用, Q8_0)'},
    ...
    {'name': 'base.en-q5_1', 'size': '57 MB', 'description': '小型・高速 (英語専用, Q5_1)'},
    {'name': 'base.en-q8_0', 'size': '78 MB', 'description': '小型・高速 (英語専用, Q8_0)'},

    // Small models
    {'name': 'small', 'size': '466 MB', 'description': '中型・バランス型 (多言語)'},
    {'name': 'small-q5_1', 'size': '181 MB', 'description': '中型・バランス型 (量子化Q5_1)'},
    {'name': 'small-q8_0', 'size': '252 MB', 'description': '中型・バランス型 (量子化Q8_0)'},
    {'name': 'small.en', 'size': '466 MB', 'description': '中型・バランス型 (英語専用)'},
    {'name': 'small.en-q5_1', 'size': '181 MB', 'description': '中型・バランス型 (英語専用, Q5_1)'},
    {'name': 'small.en-q8_0', 'size': '252 MB', 'description': '中型・バランス型 (英語専用, Q8_0)'},
    {'name': 'small.en-tdrz', 'size': '465 MB', 'description': '中型 (英語専用, 話者分離対応)'},

    // Medium models
    {'name': 'medium', 'size': '1.5 GB', 'description': '大型・高精度 (多言語)'},
    {'name': 'medium-q5_0', 'size': '514 MB', 'description': '大型・高精度 (量子化Q5_0)'},
    {'name': 'medium-q8_0', 'size': '785 MB', 'description': '大型・高精度 (量子化Q8_0)'},
    {'name': 'medium.en', 'size': '1.5 GB', 'description': '大型・高精度 (英語専用)'},
    {'name': 'medium.en-q5_0', 'size': '514 MB', 'description': '大型・高精度 (英語専用, Q5_0)'},
    {'name': 'medium.en-q8_0', 'size': '785 MB', 'description': '大型・高精度 (英語専用, Q8_0)'},

    // Large models
    {'name': 'large-v1', 'size': '2.9 GB', 'description': '最大精度 v1 (多言語)'},
    {'name': 'large-v2', 'size': '2.9 GB', 'description': '最大精度 v2 (多言語)'},
    {'name': 'large-v2-q5_0', 'size': '1.1 GB', 'description': '最大精度 v2 (量子化Q5_0)'},
    {'name': 'large-v2-q8_0', 'size': '1.5 GB', 'description': '最大精度 v2 (量子化Q8_0)'},
    {'name': 'large-v3', 'size': '2.9 GB', 'description': '最大精度 v3 (多言語)'},
    {'name': 'large-v3-q5_0', 'size': '1.1 GB', 'description': '最大精度 v3 (量子化Q5_0)'},

    // Large-v3-turbo models
    {'name': 'large-v3-turbo', 'size': '1.5 GB', 'description': '最新高速版 (多言語)'},
    {'name': 'large-v3-turbo-q5_0', 'size': '547 MB', 'description': '最新高速版 (量子化Q5_0)'},
    {'name': 'large-v3-turbo-q8_0', 'size': '834 MB', 'description': '最新高速版 (量子化Q8_0)'},
  ];
